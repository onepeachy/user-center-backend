package com.tjq.usercenter.service.impl;
...
import com.tjq.usercenter.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    //盐值，混淆密码
    private static final String SALT = "tjq";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword, String planetCode) {
        ...
        String validPAttern = "^[a-zA-Z0-9@._-]*[^@._-][a-zA-Z0-9@._-]*$";
        Matcher matcher = Pattern.compile(validPAttern).matcher(userAccount);
        if (!matcher.find()) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "账号未符合");
        }
    ...
    public User userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        if (user == null) {
            log.info("user Login Failed, userAccount cant match!");
            return null;
        }
